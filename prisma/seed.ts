  ...
  const products = await Promise.all([
    ...
    prisma.product.create({
      data: {
        ...
        mainImage: "https://picsum.photos/id/1/800/600",
    ...
    prisma.product.create({
      data: {
        ...
        mainImage: "https://picsum.photos/id/21/800/600",
    ...
    prisma.product.create({
      data: {
        ...
        mainImage: "https://picsum.photos/id/1060/800/600",
    ...
    prisma.product.create({
      data: {
        ...
        mainImage: "https://picsum.photos/id/71/800/600",
        images: ["https://picsum.photos/id/71/800/600"],
        stock: 22,
        lowStockThreshold: 5,
        categoryId: categories[3].id,
        sellerId: sellers[3].id,
    ...
    prisma.product.create({
      data: {
        ...
        mainImage: "https://picsum.photos/id/1084/800/600",
        images: ["https://picsum.photos/id/1084/800/600"],
        stock: 44,
        lowStockThreshold: 10,
        categoryId: categories[2].id,
        sellerId: sellers[2].id,
