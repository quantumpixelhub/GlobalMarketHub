    ...
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        <button
          ...
          className="flex items-center gap-2 bg-rose-600 text-white px-6 py-2 rounded-lg hover:bg-rose-700"
        >
          <Plus size={20} />
          Add Product
        </button>
            ...
            return (
              <div key={category.id} className="bg-white rounded-lg shadow overflow-hidden">
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-amber-100 to-orange-100 px-6 py-4 flex items-center justify-between hover:from-amber-200 hover:to-orange-200 transition"
                >
                  <div className="flex items-center gap-3 text-left">
                    {isExpanded ? (
                      <ChevronDown size={20} className="text-amber-700 flex-shrink-0" />
                    ) : (
                      <ChevronRight size={20} className="text-amber-700 flex-shrink-0" />
                    )}
                    <div>
                            ...
                            .map((product) => (
                              <tr key={product.id} className="border-b hover:bg-gray-50">
                                ...
                                <td className="px-6 py-4">
                                  <span className={product.stock > 0 ? 'text-rose-600' : 'text-red-600'}>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
          <form onSubmit={handleSaveProduct} className="bg-white rounded-lg max-w-2xl w-full p-6 max-h-[90vh] overflow-y-auto">
            ...
            <div className="mt-6 border-t pt-4">
              <div className="flex items-center justify-between mb-3">
                ...
                <button
                  ...
                  className="inline-flex items-center gap-2 px-3 py-2 rounded bg-rose-100 text-rose-700 hover:bg-rose-200"
                >
                  <Plus size={16} />
                  Add Variant
                </button>
            ...
            <div className="mt-6 flex gap-3">
              ...
              <button type="submit" disabled={saving} className="flex-1 bg-rose-600 text-white px-4 py-2 rounded hover:bg-rose-700 disabled:bg-rose-300">
