        ...
        <div className="flex-1 max-w-7xl mx-auto px-4 py-10 w-full">
          <div className="min-h-[55vh] flex items-center justify-center">
            <div className="w-full max-w-xl bg-white border border-gray-200 rounded-2xl shadow-sm p-8 text-center">
              <div className="mx-auto mb-4 h-12 w-12 rounded-full border-4 border-rose-100 border-t-rose-600 animate-spin" />
      ...
      <div className="flex-1 max-w-7xl mx-auto px-4 py-8 w-full">
        ...
        {isGuestCheckout && (
          <div className="mb-6 rounded-lg border border-rose-200 bg-rose-50 p-4">
            <p className="font-semibold text-rose-900">Guest Checkout</p>
        ...
        <div className="mb-6 grid grid-cols-1 md:grid-cols-3 gap-3">
          <div className="rounded-lg border border-rose-200 bg-rose-50 px-4 py-3">
            <p className="text-xs font-semibold uppercase tracking-wide text-rose-700">Step 1</p>
          ...
          <div className="rounded-lg border border-rose-200 bg-rose-50 px-4 py-3">
            <p className="text-xs font-semibold uppercase tracking-wide text-rose-700">Step 2</p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            {!isGuestCheckout ? (
              addresses.length > 0 ? (
                ...
                <form onSubmit={handleCreateAddressAndCheckout} className="bg-white rounded-lg p-6 space-y-5">
                  ...
                  <button type="submit" disabled={submitting || !cart?.items?.length} className="w-full bg-rose-600 text-white py-3 rounded-lg hover:bg-rose-700 disabled:bg-gray-400 font-semibold">
              ...
              <form onSubmit={handleGuestCheckout} className="bg-white rounded-lg p-6 space-y-5">
                ...
                <button
                  ...
                  className="w-full bg-rose-600 text-white py-3 rounded-lg hover:bg-rose-700 disabled:bg-gray-400 font-semibold"
                >
          ...
          <div className="bg-white rounded-lg p-6 h-fit sticky top-20">
            ...
            <div className="space-y-3 mb-4">
              ...
              <div className="bg-rose-50 border border-rose-200 rounded p-3 mb-2">
                <div className="flex justify-between text-sm mb-1">
                  <span className="font-medium">Shipping:</span>
                  <span className="font-bold text-rose-600">৳{shipping.toLocaleString()}</span>
                </div>
