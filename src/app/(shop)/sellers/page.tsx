      ...
      <div className="flex-1">
        ...
        <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <a href="/seller-signup" className="inline-block bg-white text-blue-600 px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition">
              Apply Now
            </a>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="bg-blue-50 rounded-lg p-12 text-center">
            ...
            <a href="/seller-signup" className="inline-block bg-blue-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-blue-700 transition">
              Apply as a Seller
            </a>
          </div>
        </div>
