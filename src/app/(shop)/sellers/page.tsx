      ...
      <div className="flex-1">
        ...
        <div className="bg-gradient-to-r from-rose-600 to-rose-700 text-white py-16">
          <div className="max-w-7xl mx-auto px-4 text-center">
            ...
            <a href="/seller-signup" className="inline-block bg-white text-rose-600 px-8 py-3 rounded-lg font-bold hover:bg-gray-100 transition">
              Apply Now
            </a>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 py-12">
          ...
          <div className="mb-16">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              <div className="bg-white rounded-lg shadow p-8 text-center">
                <Globe size={48} className="mx-auto text-rose-600 mb-4" />
              ...
              <div className="bg-white rounded-lg shadow p-8 text-center">
                <TrendingUp size={48} className="mx-auto text-rose-600 mb-4" />
              ...
              <div className="bg-white rounded-lg shadow p-8 text-center">
                <DollarSign size={48} className="mx-auto text-rose-600 mb-4" />
          ...
          <div className="bg-rose-50 rounded-lg p-12 text-center">
            ...
            <a href="/seller-signup" className="inline-block bg-rose-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-rose-700 transition">
              Apply as a Seller
            </a>
          </div>
        </div>
