          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {blogs.map((blog) => (
              <div key={blog.id} className="bg-white rounded-lg shadow overflow-hidden hover:shadow-lg transition">
                {/* Image */}
                <div className="bg-gradient-to-r from-emerald-100 to-emerald-50 h-48 flex items-center justify-center text-6xl">
                  {blog.image}
                </div>
                ...
                <div className="p-6">
                  ...
                  <h3 className="text-xl font-bold mb-3 line-clamp-2 hover:text-emerald-600">
                    {blog.title}
                  </h3>
