      ...
      <div className="flex-1">
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
            ...
            {faqs.map((faq, index) => (
              <div key={index} className="bg-white rounded-lg shadow">
                ...
                >
                  ...
                  <ChevronDown
                    size={24}
                    className={`flex-shrink-0 text-emerald-600 transition ${
          ...
          <div className="mt-12 bg-emerald-50 rounded-lg p-8 text-center">
            ...
            <a
              href="/contact"
              className="inline-block bg-emerald-600 text-white px-8 py-3 rounded-lg font-bold hover:bg-emerald-700 transition"
            >
              Contact Support
            </a>
          </div>
