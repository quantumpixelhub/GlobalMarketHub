      ...
      <div className="max-w-7xl mx-auto px-4 py-3 md:py-4">
        <div className="flex flex-col lg:flex-row lg:items-center gap-3 md:gap-4 mb-2 md:mb-3">
          ...
          <div className="w-full lg:w-[265px] flex-shrink-0">
            <Logo size="lg" imageScale={5} className="origin-left" />
          </div>
          ...
          <div className="flex items-center gap-6 md:gap-7 self-end lg:self-auto flex-shrink-0">
            ...
            <Link
              href="/wishlist"
              className="relative hover:text-rose-600 transition-colors group"
              title="Wishlist"
            >
              <Heart size={22} />
                    ...
                    return (
                      <div key={category.id} className="relative group flex-shrink-0">
                        <Link
                          ...
                          className="flex items-center gap-1.5 text-xs whitespace-nowrap hover:text-rose-600 transition-colors py-3 px-1.5 border-b-2 border-transparent hover:border-rose-600"
                        >
                          ...
                          <div className="absolute left-0 top-full bg-white border border-gray-200 rounded shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all z-50 w-max">
                            {subcategories.map((sub) => (
                              <Link
                                ...
                                className="flex items-center gap-2 px-4 py-2 text-sm text-gray-700 hover:bg-rose-50 hover:text-rose-600 transition-colors first:rounded-t last:rounded-b whitespace-nowrap"
                              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                  {categoryTree.map((parent) => (
                    <details key={`all-${parent.id}`} className="rounded border border-gray-100 overflow-hidden">
                      <summary className="list-none cursor-pointer flex items-start gap-3 font-semibold text-gray-900 hover:text-rose-600 p-2 bg-gray-50/50 hover:bg-rose-50/50">
                        ...
                        <div className="flex-1 min-w-0">
                          <Link
                            ...
                            className="block hover:text-rose-600 font-semibold text-sm"
                          >
                            {parent.name}
                          </Link>
                        ...
                        <div className="mt-2 ml-2 space-y-1 border-l border-gray-200 pl-3 bg-white p-2">
                          {parent.children.map((sub) => (
                            <Link
                              ...
                              className="flex items-center gap-2 text-xs text-gray-600 hover:text-rose-600 p-1"
                            >
